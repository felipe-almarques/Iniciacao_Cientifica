function dLoglike = loglikelihoodGaussianCopulaGASmodel(vParms, info, mData)
...
vOmega = vRestrictedParms(1,1);
mA = vRestrictedParms(2,1);
mB = vRestrictedParms(3,1);
...
% return the scaled loglikelihood. Negative for Matlab's optimization
% function
dLoglike = -1*dLoglike/iT;
